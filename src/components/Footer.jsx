...
function Footer() {
  return (
    <footer className="footer">
      ...
      <ul class="footer-sns">
			<li class="footer-sns__item"><a href="https://www.instagram.com/iimtrichy/" target="_blank">
					<img class="lozad" src={insta} width="38" height="38" alt="instagram" decoding="async" /></a></li>
			<li class="footer-sns__item"><a href="https://www.linkedin.com/school/iimtrichy/" target="_blank">
					<img class="lozad" src={linkedIn} width="38" height="38" alt="linkedin" decoding="async" /></a></li>
			<li class="footer-sns__item"><a href="https://www.facebook.com/IIMTiruchirappalli/" target="_blank">
					<img class="lozad" src={facebook} width="38" height="38" alt="facebook" decoding="async" /></a></li>
			<li class="footer-sns__item"><a href="https://www.youtube.com/channel/UCXMk9MRdGrNHIK6HN2JeLCQ" target="_blank">
					<img class="lozad" src={youtube} width="38" height="38" alt="youtube" decoding="async" /></a></li>
		</ul>
      <p className='footer-outside'>&copy; 2024 IIT Bombay Clone. All rights reserved.</p>
    </footer>
  );
}
