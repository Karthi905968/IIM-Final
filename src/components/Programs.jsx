...
const programs = [
  {
    ...
    programs: [
      ...
      },
      {
        ...
        image: mbahr,
        description:
          "Post-Graduate Programme in Management-Human Resources (PGPM-HR) is a two-year full-time residential programme launched in 2020.",
      },
    ],
  },
  {
    ...
    programs: [
      {
        ...
        image: phd,
        description:
          "The Doctoral Programme in Management is a full-time doctoral programme that offers students opportunities for research in different areas of Management.",
      },
    ],
  },
  {
